# Generated by Django 2.2.7 on 2020-08-20 23:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_type', models.CharField(choices=[('qa', 'Quality Assurance'), ('qc', 'Quality Control')], max_length=16, verbose_name='Type')),
                ...
                ('assessor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='assessment_group_set', to=settings.AUTH_USER_MODEL, verbose_name='Assessed by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='assessment_set', to=settings.AUTH_USER_MODEL, verbose_name='Assessed by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_location', models.CharField(choices=[('attached', 'Attached'), ('url', 'Link')], default='attached', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(help_text='Short label for the subject of this assessment', max_length=128, verbose_name='Subject')),
                ('description', models.TextField(blank=True, help_text='Optional longer description of the assessment subject.')),
                ('record', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='assess_assessmentsubject', to='assess.AssessmentRecord')),
            ],
            options={
